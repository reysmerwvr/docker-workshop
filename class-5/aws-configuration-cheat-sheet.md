...
8. You should see a green check-mark after some time.

9. Click the link above the check-mark for your application. This should open the application in your browser and display a Congratulations message.
...
4. The status should eventually return with a green check-mark and show "build passing"

5. Go to your AWS Elasticbeanstalk application

6. It should say "Elastic Beanstalk is updating your environment"

7. It should eventually show a green check-mark under "Health". You will now be able to access your application at the external URL provided under the environment name.