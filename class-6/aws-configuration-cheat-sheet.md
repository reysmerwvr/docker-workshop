...
After all instances restart and go from No Data, to Severe, you should see a green check-mark under Health.
...
The status should eventually return with a green check-mark and show "build passing"
